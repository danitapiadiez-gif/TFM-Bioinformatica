...
conjunto, 240 de las 1397 muestras disponibles (17,2\,\%) quedaron fuera del
...
\emph{balanced accuracy} media fue de 0,773 y la ganancia media respecto al azar
informado, de $+$0,116. Tres de las ocho cohortes evaluables no superan su
propio \emph{baseline}: GSE23066 lo iguala (0,500 frente a 0,500), GSE31210
queda ligeramente por debajo (0,898 frente a 0,919) y GSE40791 lo hace de forma
drástica (0,167 frente a 0,833). La figura~\ref{fig:lodo} representa cada
...
cohortes evaluables, el AUC medio fue de 0,925 mientras que la
\emph{balanced accuracy} media se quedó en 0,773. La divergencia entre ambas
métricas es sistemática, no anecdótica, y alcanza su expresión más extrema en
GSE40791: \emph{accuracy} de 0,167 con un AUC de 1,000.
...
causa: la sensibilidad media es de 0,983 y la especificidad media, de 0,563. El
...
entre muestras tumorales fue de $\rho=-0{,}637$, por debajo del criterio fijado,
y solo dos de las cuatro cohortes con tumores suficientes lo superan
...
panel de proliferación ($\rho$ entre $+0{,}267$ y $+0{,}719$). El clasificador
...
100,0\,\% --- perfecta, en todos los pares sin excepción ---, mientras que
parejas de mitades disjuntas de tamaño comparable ($n\approx328$ cada una)
concuerdan al 73,98\,\%. La caída de 26 puntos es atribuible al solapamiento y
...
\emph{balanced accuracy} media de 0,940 y AUC media de 0,967, con una ganancia
media de $+$0,296 sobre el azar informado. Se derivó además una firma de 1174
...
El resultado anterior se obtuvo excluyendo 177 muestras --- el 31,3\,\% de los
...
\textbf{La hipótesis no se confirmó.} Solo el 29,9\,\% de las muestras ambiguas
recibe una asignación de alta confianza, frente al 62,6\,\% de las muestras que
...
recuperando la biología correcta. En cambio, de los 101 tumores neuroendocrinos
(neuroendocrino de célula grande, microcítico y carcinoide), el 93\,\% se asigna
...
El AUC de 0,967 de la sección~\ref{sec:subtipo} es válido únicamente sobre
...
\item Los datos presentan cuatro modos de fallo silencioso y cuantificables:
      tres cohortes declaradas nunca procesadas, 307 muestras con etiqueta
      cruzada, 240 muestras (17,2\,\%) perdidas en la curación automatizada y
      tres cohortes de una sola clase empleadas como conjunto de test. Ninguno
      generó un error en tiempo de ejecución.
\item En la tarea tumor frente a sano, la \emph{balanced accuracy} media sobre
      cohortes evaluables es de 0,773, con tres de ocho por debajo de su propio
      \emph{baseline}.
\item La firma transfiere su capacidad de ordenación entre cohortes (AUC medio
      0,925) pero no su umbral de decisión (especificidad media 0,563), un
...
\item La composición tisular explica una parte sustancial de la señal
      ($\rho=-0{,}637$ entre tumores) sin agotarla, y coexiste con un eje de
      proliferación no previsto.
\item La consistencia de signo entre \emph{folds} LODO no mide reproducibilidad
      biológica: alcanza el 100,0\,\% frente al 73,98\,\% de modelos disjuntos
...
\item El marco metodológico sí recupera biología reproducible cuando existe
      (subtipo histológico, AUC 0,967, con los doce marcadores de
