...
coexistencia de un AUC medio de \aucmedia{} con una \emph{balanced accuracy} media de
\balacc{}, y su expresión extrema en GSE40791 (\emph{accuracy} \acccc{} con AUC 1,000),
...
sensibilidad media de \sensmedia{} frente a una especificidad media de \especmedia{} describe un
...
($|\rho|>0{,}7$; obtenido $\rho=-\rhotumoresabs$). Mantener ese criterio obliga a una
...
proliferación, entre $+\rhoprolifmin$ y $+\rhoprolifmax$ --- indica que el clasificador
...
Debe señalarse una limitación de este análisis: solo \nrho{} cohortes reunían
...
concordancia direccional resultante es del \conclodo\,\% en la totalidad de los
...
tamaño comparable (\concdisjunta\,\%) delimita cuánto de ese \conclodo\,\% procede del
solapamiento.
...
con AUC medio de \aucsub{} y recuperación completa de los doce marcadores de
...
Segundo, el resultado se obtuvo excluyendo el \pctexcluidas\,\% de los tumores
...
muestras de lo previsto (\pctconfambiguas\,\% de asignaciones de alta confianza frente al
\pctconfvistas\,\% en muestras de clase conocida; la hipótesis registrada no se confirmó),
pero también que el \pctneuroadc\,\% de los \nneuro{} tumores neuroendocrinos se etiqueta como
