...
\begin{enumerate}
  ...
  GEO heterogéneas, con nueve cohortes por encima del 95\,\%. Esto habilita
  la integración multi-cohorte a un coste marginal accesible y sin
  intervención manual.
  ...
  independientes, con balanced accuracy 0,940. Este rendimiento se
  mantiene en validación externa, sin depender de particiones internas
  ...
  0,970 de la firma completa (1174 genes), la pérdida es inferior a 0,01.
  El panel es susceptible de ser medido mediante PCR cuantitativa o
  \emph{NanoString} y podría complementar la IHC diagnóstica en casos
  histológicamente ambiguos.

  \item \textbf{La firma recupera el panel diagnóstico IHC de la OMS
  con altísima cobertura.} De los 20 marcadores clínicos, el framework
  recupera 18 (12/12 escamosos, 6/8 adenocarcinoma) sin haberlos
  declarado durante el entrenamiento. Los dos marcadores no recuperados
  (SFTPA1, SFTPC) son proteínas del surfactante cuya expresión cae de
  forma homogénea entre ambos subtipos NSCLC.
  ...
  sano, hasta $\rho=-0{,}858$ en GSE31210) y actividad proliferativa
  aumentada. La firma no es una caja negra: refleja mecanismos
  oncológicos conocidos.
  ...
  media LODO de 0,925 con balanced accuracy 0,772. La brecha entre ambas
  métricas se atribuye al desbalance del entrenamiento (938 tumores frente
  a 219 controles curados en total) y es corregible mediante técnicas
  estándar de recalibración por cohorte.
  ...
  de comandos. Las semillas aleatorias están fijadas y los resultados
  intermedios se persisten en disco. La interfaz web y el asistente
  conversacional leen los mismos ficheros, lo que garantiza la
  coherencia de las cifras mostradas.
\end{enumerate}
