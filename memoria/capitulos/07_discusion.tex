...
publicada sobre clasificación molecular de NSCLC a partir de expresión
génica. Wilkerson et al.~\cite{wilkerson2010lusc} definen los subtipos
moleculares reproducibles del carcinoma escamoso; el consorcio TCGA
publica caracterizaciones moleculares comprehensivas de adenocarcinoma
sobre grandes cohortes~\cite{tcga2014luad}, pero sin validación externa
en cohortes independientes. Chen et al.~\cite{chen2017gene} proponen una
firma pronóstica de 5 genes con AUC 0,83 en validación externa. La firma
presentada en este trabajo obtiene AUC 0,968 en validación externa sobre
tres cohortes independientes microarray, y AUC 0,857 al transferirla a
TCGA RNA-Seq (n=408), con un panel mínimo de 20 genes.
La tabla~\ref{tab:comparativa} sitúa la firma frente a algunas de las más
relevantes publicadas en las últimas dos décadas.
...
\begin{table}[H]
  ...
  \begin{tabular}{lllrrl}
    ...
    Wilkerson et al.~\cite{wilkerson2010lusc}    & 2010 & Subtipos SQC (mRNA)     & \emph{n.\,d.} & --    & Múltiples cohortes \\
    TCGA~\cite{tcga2014luad}                  & 2014 & Perfilado LUAD           & \emph{n.\,d.} & --    & Interna (TCGA) \\
